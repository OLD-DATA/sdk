...
public:
	...
	virtual BOOL GetNextBestWeapon( CBasePlayer *pPlayer, CBasePlayerItem *pCurrentWeapon, BOOL alwaysSearch);// I can't use this weapon anymore, get me the next best one.
...
// GR_Think
	...
	virtual BOOL GetNextBestWeapon( CBasePlayer *pPlayer, CBasePlayerItem *pCurrentWeapon, BOOL alwaysSearch = FALSE );
