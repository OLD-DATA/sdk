...
// hit the world, try to play sound based on texture material type
	...
	else if (chTextureType == CHAR_TEX_COMPUTER)
	{
		...
		if ( ptr->flFraction != 1.0 && RANDOM_LONG(0,1))
		{
			...
			{
				case 0: UTIL_EmitAmbientSound(CWorld::Instance->edict(), ptr->vecEndPos, "buttons/spark5.wav", flVolume, ATTN_NORM, 0, 100); break;
				case 1: UTIL_EmitAmbientSound(CWorld::Instance->edict(), ptr->vecEndPos, "buttons/spark6.wav", flVolume, ATTN_NORM, 0, 100); break;
